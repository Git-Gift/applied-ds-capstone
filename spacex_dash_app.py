...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site',
        title='All Launch Sites Success Pie Chart')
        return fig
    else:
        ...
        names='class',
        title= f'{entered_site} Success Pie Chart')
        return fig
# TASK 4:
...
def scatter(entered_site, payload):
    ...
    if entered_site=='ALL':
        ...
        title='All Launch Site Success Payload Scatter Chart')
        return fig
    else:
        fig=px.scatter(filtered_df[filtered_df['Launch Site'] == entered_site],x='Payload Mass (kg)',y='class',
        color='Booster Version Category',
        title=f'{entered_site} Success Payload Scatter Chart')
        return fig
# Run the app
